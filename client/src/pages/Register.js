    ...
    try {
      ...
      const msg =
        code === 'auth/unauthorized-domain'
          ? 'Google sign-up blocked: localhost not authorized in Firebase Console.'
          : code === 'auth/operation-not-allowed'
          ? 'Google sign-in is not enabled. Enable it in Firebase Console.'
          : code === 'auth/popup-closed-by-user'
          ? 'Popup was closed. Please try again.'
          : `Google sign-up failed: ${code || err.message}`;
      toast.error(msg);
    } finally {
    ...
    <div className="auth-page">
      ...
      <div className="auth-card animate-fade-in-up">
        <div className="auth-header">
          ...
          <p className="auth-subtitle">Start your interview prep journey — it's free</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input id="name" type="text" name="name" className="form-input"
              placeholder="Your full name" value={form.name} onChange={handleChange} required autoFocus />
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <div style={{ position: 'relative' }}>
              <input id="reg-password" type={showPassword ? 'text' : 'password'} name="password" className="form-input"
                placeholder="Min. 6 characters" value={form.password} onChange={handleChange} required style={{ paddingRight: '40px' }} />
              <button
                type="button"
          ...
          <div className="form-group">
            ...
            <div style={{ position: 'relative' }}>
              <input id="confirm" type={showConfirm ? 'text' : 'password'} name="confirm" className="form-input"
                placeholder="Repeat password" value={form.confirm} onChange={handleChange} required style={{ paddingRight: '40px' }} />
              <button
                type="button"
          ...
          <button id="btn-register-submit" type="submit"
            className="btn btn-primary btn-full btn-lg" disabled={loading || googleLoading}>
